...
public class ArticleController {
    ...
    @PostMapping
    public ResponseEntity<ArticleViewDto> addArticle(@AuthenticationPrincipal UserDto userDto, @RequestBody ArticleDto articleDto) {
        return ResponseEntity.ok(articleService.saveArticle(articleDto, userDto));
    }
